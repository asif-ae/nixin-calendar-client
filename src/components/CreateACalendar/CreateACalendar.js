          ...
          <form onSubmit={handleSubmit}>
            <div className="row m-0">
              <div className="col-md-6 p-0">
                <input className="form-control mb-3 bg-light" type="text" name="calendarName" id="calendarName" placeholder="Calendar name" aria-label="Calendar name" onChange={handleChange} value={calendarName} />
                <textarea className="form-control mb-3 bg-light" name="calendarDescription" id="calendarDescription" placeholder="Calendar description..." rows="5" onChange={handleChange} value={calendarDescription}></textarea>
